...
class HtmlModulesContentProvider:
    ...
    def get_content(self):
        ...
        for module in self.modules:
            ...
            content += HtmlDependencyContentProvider(self.dependency_matrix, "table", lambda x: x == module).get_content()
            content += HtmlClassUsageContentProvider(self.class_usage_matrix, "table", lambda x: x == module).get_content()
            content += f'</div>'
            content += f"</br></br>"
        return content
